  ...
  return (
    <Box mx={2}>
      <Box mx={2} mt={5}>
        ...
        <Text>
          Thế Giới Kim Cương (TGKC) là một trong những thương hiệu hàng đầu Việt
          Nam chuyên về kim cương và trang sức. Cho đến nay Công ty đã có một
          đội ngũ hơn 800 nhân viên và hệ thống 100++ cửa hàng phủ rộng khắp
          toàn quốc. Từ ngày 30/04/2020 TGKC tự hào là thành viên chính thức của
          Tập đoàn VBĐQ DOJI.
        </Text>
      </Box>
      <Box mx={2} mt={6}>
      ...
      <Box mx={2} mt={6}>
        ...
        <iframe
          style={{ width: "100%", height: 300, marginBottom: -200 }}
