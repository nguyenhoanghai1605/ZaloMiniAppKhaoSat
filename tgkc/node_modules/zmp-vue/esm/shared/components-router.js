...
import { zmpevents, zmprouters } from './zmp';
...
export default {
  proto: {
    pageComponentLoader: function pageComponentLoader(_ref) {
      ...
      var el = routerEl;
      var viewRouter;
      zmprouters.views.forEach(function (data) {
      ...
      function onDidUpdate(componentRouterData) {
        ...
        zmpevents.off('viewRouterDidUpdate', onDidUpdate);
      ...
      zmpevents.on('viewRouterDidUpdate', onDidUpdate);
    ...
    tabComponentLoader: function tabComponentLoader(_temp) {
      ...
      if (!tabEl) reject();
      var tabRouter;
      zmprouters.tabs.forEach(function (tabData) {
      ...
      function onDidUpdate(componentRouterData) {
        ...
        zmpevents.off('tabRouterDidUpdate', onDidUpdate);
        var tabContentEl = tabEl.children[0];
        resolve(tabContentEl);
        resolved = true;
      }

      zmpevents.on('tabRouterDidUpdate', onDidUpdate);
    ...
    modalComponentLoader: function modalComponentLoader(_temp2) {
      ...
      var router = this;
      var modalsRouter = zmprouters.modals;
      ...
      function onDidUpdate() {
        if (resolved) return;
        zmpevents.off('modalsRouterDidUpdate', onDidUpdate);
      ...
      zmpevents.on('modalsRouterDidUpdate', onDidUpdate);
