...
import zmpTextEditor from './text-editor';
export default {
  name: 'zmp-list-input',
  props: _extends({
    sortable: {
  ...
  setup: function setup(props, _ref) {
    ...
    var validateInput = function validateInput() {
      if (!zmp || !inputElRef.value) return;
    ...
    onMounted(function () {
      ...
      zmpready(function () {
        ...
        if (props.type === 'datepicker') {
          zmpCalendar = zmp.calendar.create(_extends({
        ...
        if (props.type === 'colorpicker') {
          zmpColorPicker = zmp.colorPicker.create(_extends({
            inputEl: inputElRef.value,
            value: props.value,
            on: {
        ...
        if (props.type === 'textarea' && props.resizable) {
          zmp.input.resizeTextarea(inputElRef.value);
        }
      });
    });
    ...
    watch(function () {
      ...
      if (!zmp || !zmpColorPicker) return;
      extend(zmpColorPicker.params, newValue || {});
    });
    watch(function () {
      return props.calendarParams;
    }, function (newValue) {
      if (!zmp || !zmpCalendar) return;
      extend(zmpCalendar.params, newValue || {});
    });
    watch(function () {
      return props.value;
    }, function (newValue) {
    ...
    return function () {
      ...
      if (props.input) {
        if (props.type === 'select' || props.type === 'textarea' || props.type === 'file') {
          ...
          inputEl = h(zmpTextEditor, _extends({
            value: props.value,
