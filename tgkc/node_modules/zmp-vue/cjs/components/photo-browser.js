...
var _default = {
  ...
  setup: function setup(props, _ref) {
    var emit = _ref.emit;
    var zmpPhotoBrowser = null;

    var open = function open(index) {
      return zmpPhotoBrowser.open(index);
    };

    var close = function close() {
      return zmpPhotoBrowser.close();
    };

    var expositionToggle = function expositionToggle() {
      return zmpPhotoBrowser.expositionToggle();
    };

    var expositionEnable = function expositionEnable() {
      return zmpPhotoBrowser.expositionEnable();
    };

    var expositionDisable = function expositionDisable() {
      return zmpPhotoBrowser.expositionDisable();
    };

    (0, _vue.watch)(function () {
      return props.photos;
    }, function (value) {
      var pb = zmpPhotoBrowser;
      if (!pb) return;
    ...
    (0, _vue.onMounted)(function () {
      ...
      (0, _zmp.zmpready)(function () {
        ...
        zmpPhotoBrowser = _zmp.zmp.photoBrowser.create(paramsComputed);
      });
    });
    (0, _vue.onBeforeUnmount)(function () {
      if (zmpPhotoBrowser && zmpPhotoBrowser.destroy) zmpPhotoBrowser.destroy();
      zmpPhotoBrowser = null;
    });
    return {
      open: open,
      close: close,
